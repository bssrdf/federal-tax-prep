...
def build_data():
    ...
    line_8 = capital_gains_tax_brackets[0]["threshold"]
    ...
    line_15 = capital_gains_tax_brackets[1]["threshold"]
    ...
    line_20 = line_19 * capital_gains_tax_brackets[0]["tax_rate"]
    ...
    line_23 = line_22 * capital_gains_tax_brackets[1]["tax_rate"]
    data_dict['line_23'] = line_23

    line_24 = utils.calculate_tax_due(line_7, filing_status=filing_status)
    data_dict['tax_table_amount_line7'] = line_24

    line_25 = line_20 + line_23 + line_24
    data_dict['line_25'] = line_25

    line_26 = utils.calculate_tax_due(line_1, filing_status=filing_status)
...
def fill_in_form():
    ...
    basename = 'worksheet__capital_gains.pdf'
    return utils.write_fillable_pdf(basename, data_dict, 'worksheet__capital_gains.keys')
